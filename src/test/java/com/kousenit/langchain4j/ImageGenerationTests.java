 ...
 *
 * <p>This lab demonstrates how to use LangChain4j with OpenAI's DALL-E for image generation. You'll
 * learn how to: - Generate images using OpenAI's DALL-E model - Configure image generation options
 * (size, quality, style) - Use image generation with AiServices for structured approaches - Handle
 * and process generated images
 */
class ImageGenerationTests {
   ...
   *
   * <p>TODO: Demonstrates how to generate a simple image using OpenAI's DALL-E model.
   *
   * <p>Instructions: 1. Create an OpenAI ImageModel using the builder pattern 2. Set the API key
   * from environment variables 3. Use the "dall-e-3" model name 4. Generate an image with a
   * creative prompt 5. Verify the response and extract the image URL 6. Print the generated image
   * URL and any revised prompt
   */
  @Test
  void basicImageGeneration() {
    ...
    // String prompt = "A majestic dragon soaring over a crystal castle at sunset, fantasy art
    // style";
   ...
   *
   * <p>TODO: Demonstrates how to generate images with specific configuration options.
   *
   * <p>Instructions: 1. Create an OpenAI ImageModel with specific options 2. Set size to
   * "1024x1024" 3. Set quality to "hd" 4. Set style to "vivid" 5. Generate an image with detailed
   * configuration 6. Verify the enhanced image quality
   */
  @Test
  void imageGenerationWithOptions() throws IOException {
    ...
    // String prompt = "A futuristic cityscape at dawn with flying vehicles, neon lights reflecting
    // on wet streets,
    // cyberpunk aesthetic";
   ...
   *
   * <p>TODO: Demonstrates generating images with different artistic styles and detailed prompts.
   *
   * <p>Instructions: 1. Create an OpenAI ImageModel with production settings 2. Generate images
   * with different artistic styles 3. Test both artistic and technical prompt styles 4. Verify both
   * images are generated successfully 5. Compare the revised prompts with the original prompts
   */
  @Test
  void advancedImageGeneration() {
    ...
    // String artisticPrompt = "A serene Japanese garden with cherry blossoms, traditional
    // architecture, and a koi
    // pond, watercolor painting style";
    ...
    // String technicalPrompt = "A detailed cross-section of a mechanical watch showing gears,
    // springs, and
    // intricate components, technical illustration style";
   ...
   *
   * <p>TODO: Demonstrates generating multiple variations of images with different prompts.
   *
   * <p>Instructions: 1. Create an ImageModel with consistent settings 2. Generate images with
   * different artistic styles 3. Test various prompt engineering techniques 4. Compare results
   ...
   *
   * <p>TODO: Demonstrates using the new OpenAI "gpt-image-1" model that returns base64-encoded
   * images.
   *
   * <p>Instructions: 1. Create an OpenAI ImageModel using the new "gpt-image-1" model (no constant
   * available yet) 2. Generate an image with a creative prompt about a warrior cat and dragon 3.
   * Extract base64 data using image.base64Data() or parse from data URL 4. Decode the base64 string
   * using Java's Base64.getDecoder() 5. Write the decoded bytes to a file in src/main/resources/ 6.
   * Verify the file was created and contains valid image data 7. Display educational output about
   * the process
   */
  @Test
