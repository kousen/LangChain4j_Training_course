 ...
 * Lab 6: AI Tools
 *
 * <p>This lab demonstrates how to extend AI capabilities using custom tools with the @Tool
 * annotation. You'll learn how to: - Create tool classes with @Tool annotation for AI function
 * calling - Integrate tools with AiServices for enhanced AI capabilities - Build tools that accept
 * parameters for dynamic functionality - Combine multiple tools for comprehensive AI assistants
 *
...
class AiToolsTests {
     ...
     *    - getWeatherWithDefault(String city, Optional<String> units) - optional parameter pattern
     *
    ...
    /**
     * Assistant interface for AI services with tool integration. You can use this interface for all
     * your tool tests.
     */
    interface Assistant {
     ...
     *
     * <p>Implement a test that: 1. Creates an OpenAI chat model 2. Creates an Assistant with
     * DateTimeTool using AiServices.builder() 3. Tests asking for current time, future date
     * calculation, and alarm setting 4. Verifies responses are not null and contain expected content
     *
     * <p>Hint: Use .tools(new DateTimeTool()) when building the AiServices The DateTimeTool class is
     * already available - just instantiate it!
     */
    @Test
     ...
     *
     * <p>Implement a test that: 1. Creates an Assistant with WeatherTool 2. Tests weather queries for
     * different cities and units 3. Verifies the tool correctly uses the provided parameters
     */
    @Test
     ...
     *
     * <p>Implement a test that: 1. Creates an Assistant with ALL tools (DateTimeTool, CalculatorTool,
     * WeatherTool) 2. Tests complex queries that require multiple tools 3. Verifies the AI can
    ...
    /**
     * TODO 6.5: Optional Tool Parameters Test
     *
     * <p>LangChain4j 1.12 added {@code Optional<T>} support for tool parameters. Implement a test
     * that: 1. Creates an Assistant with WeatherTool 2. Asks for weather without specifying units 3.
     * Verifies the tool falls back to metric units through getWeatherWithDefault
     */
    @Test
    void optionalToolParameters() {
        ...
        // TODO: Ask for weather in a city without specifying units
        // "What's the weather in Berlin? I don't care about units."

        // TODO: Verify the response contains the city and uses the default units

        fail("TODO: Implement optional tool parameters test");
    }
     ...
     * chaining (multiple steps with tools)
     */
    @Test
    ...
    /**
     * TODO 6.7: Tool Error Handling Test (Optional Advanced Exercise)
     *
     * <p>Implement a test that verifies tools handle errors gracefully: 1. Test division by zero with
     * CalculatorTool 2. Compare with normal calculations 3. Verify the AI handles tool errors
     * appropriately
     */
    @Test
