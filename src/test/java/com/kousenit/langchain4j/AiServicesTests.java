...
class AiServicesTests {
  ...
  interface DocumentAnalyzer {
    ...
    @dev.langchain4j.service.UserMessage(
        "Analyze this document content and provide key insights: {{content}}")
    ...
    @dev.langchain4j.service.UserMessage(
        "Rate the sentiment of this content from 1-10: {{content}}")
  ...
  interface CreativeWritingService {
    ...
    @dev.langchain4j.service.UserMessage(
        "Write a {{wordCount}}-word story about {{topic}} in the {{genre}} genre")
    String writeStory(
        @V("genre") String genre, @V("topic") String topic, @V("wordCount") int wordCount);

    @dev.langchain4j.service.UserMessage(
        "Generate {{count}} creative character names for a {{setting}} story")
    List<String> generateCharacterNames(@V("setting") String setting, @V("count") int count);

    @dev.langchain4j.service.UserMessage(
        "Rate the creativity level of this story from 1-10: {{story}}")
