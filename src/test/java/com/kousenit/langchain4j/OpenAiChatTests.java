 ...
 *
 * <p>This lab demonstrates the fundamental patterns for interacting with LangChain4j's ChatModel.
 * You'll learn how to: - Create and configure an OpenAI ChatModel - Send simple queries to the
 * model - Use system messages to modify model behavior - Access response metadata including token
...
class OpenAiChatTests {
     ...
     *
     * <p>Demonstrates basic chat interaction with OpenAI's ChatModel. Creates a model, sends a query,
     ...
     *
     * <p>Demonstrates how to use system messages to modify the model's behavior. The system message
     * acts as instructions that influence how the AI responds.
     */
    @Test
    void simpleQueryWithSystemMessage() {
        ...
        // SystemMessage systemMessage = SystemMessage.from("You are a helpful assistant that responds
        // like a pirate.");
     ...
     *
     * <p>Demonstrates how to access response metadata including token usage, finish reason, and other
     * information about the AI's response.
     */
    @Test
