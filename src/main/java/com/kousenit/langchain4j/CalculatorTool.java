 ...
 *
 * <p>This tool provides basic mathematical operations with proper error handling. It shows how to
 * implement multiple @Tool methods within a single class and demonstrates error handling for edge
