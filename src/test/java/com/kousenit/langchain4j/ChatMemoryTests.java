 ...
 * Lab 5: Chat Memory
 *
 * <p>This lab demonstrates how to maintain conversation context using LangChain4j's ChatMemory.
 * You'll learn how to: - Understand the stateless nature of AI model interactions - Use ChatMemory
 * to retain conversation state across multiple interactions - Work with different memory types
 * (MessageWindowChatMemory) - Integrate memory with AiServices for persistent conversations
 */
class ChatMemoryTests {
     ...
     *
     * <p>TODO: Demonstrate that AI models are stateless by default 1. Create an OpenAI chat model 2.
     * Send a message introducing yourself with a memorable name 3. Ask "Who am I?" in a separate call
    ...
    void defaultRequestsAreStateless() {
        ...
        // String response1 = model.chat("My name is Inigo Montoya. You killed my father. Prepare to
        // die.");
     ...
     *
     * <p>TODO: Use ChatMemory to maintain conversation state across interactions 1. Create an OpenAI
     * chat model 2. Create a MessageWindowChatMemory with capacity for 10 messages 3. Manually add
     * messages to memory and get responses 4. Verify the model remembers the previous conversation
     * when using memory
     */
    @Test
    void requestsWithMemory() {
        ...
        // UserMessage firstMessage = UserMessage.from("My name is Inigo Montoya. You killed my father.
        // Prepare to
        // die.");
        ...
        //     () -> assertTrue(memory.messages().size() >= 4, "Memory should contain at least 4
        // messages")
        // );
     ...
     *
     * <p>TODO: Compare different memory configurations 1. Create an OpenAI chat model 2. Create two
     * different MessageWindowChatMemory instances with different sizes 3. Add the same conversation
     * history to both 4. Test how they respond differently based on their capacity
     */
    @Test
    void differentMemoryTypes() {
        ...
        // AiMessage aiResponse = AiMessage.from("That's great! I'm here to help you learn about AI and
        // ML concepts.");
        ...
        //     () -> assertNotNull(largeResponse.aiMessage().text(), "Large memory response should not
        // be null"),
        //     () -> assertNotNull(smallResponse.aiMessage().text(), "Small memory response should not
        // be null"),
        //     () -> assertTrue(largeMemory.messages().size() <= 10, "Large memory should respect max
        // limit"),
        //     () -> assertTrue(smallMemory.messages().size() <= 3, "Small memory should respect smaller
        // limit")
        // );
     ...
     *
     * <p>TODO: Use memory with AiServices for seamless persistent conversations 1. Create an OpenAI
     * chat model 2. Create a ChatMemory instance 3. Build AssistantWithMemory using AiServices with
     * memory integration 4. Have a multi-turn conversation 5. Verify memory works across all
     * interactions
     */
    @Test
    void aiServicesWithMemory() {
        ...
        // String response1 = assistant.chat("Hi, my name is Alice and I'm a software developer working
        // on AI
        // applications.");
        ...
        //     () -> assertTrue(memory.messages().size() >= 6, "Memory should contain conversation
        // history")
        // );

        // TODO: Verify response quality and memory retention using AssertJ
        // assertThat(response2).as("Name and profession
        // recall").isNotBlank().containsIgnoringCase("alice");
     ...
     *
     * <p>TODO: Demonstrate advanced memory management patterns 1. Create a small memory window to
     * test eviction 2. Fill memory beyond its capacity 3. Verify oldest messages are evicted 4. Test
     * conversation continuity despite limited memory
     */
    @Test
    void advancedMemoryManagement() {
        ...
        //     () -> assertEquals(4, memory.messages().size(), "Memory should respect max message
        // limit"),
        //     () -> assertFalse(hasFirstMessage, "Oldest messages should be evicted"),
        //     () -> assertNotNull(response.aiMessage().text(), "Should get response despite memory
        // limits")
        // );
        ...
        // assertThat(allMessages).as("Recent memory content").contains("weather").contains("last
        // question");
    }
     ...
     *
     * <p>TODO: Demonstrate separate memory instances for different users 1. Create an OpenAI chat
     * model 2. Define a MultiUserAssistant interface with @MemoryId parameter 3. Use
     * chatMemoryProvider to create separate memory per user 4. Test conversations with multiple users
    ...
    void memoryPerUserWithMemoryId() {
        ...
        //     String chat(@MemoryId int memoryId, @dev.langchain4j.service.UserMessage String
        // userMessage);
        // }
        ...
        // String user1Response1 = assistant.chat(1, "Hello, my name is Klaus and I'm a software
        // engineer.");
        // System.out.println("User 1 (Klaus) - Introduction: " + user1Response1);

        // // User 2 introduces themselves
        // String user2Response1 = assistant.chat(2, "Hello, my name is Francine and I'm a data
        // scientist.");
     ...
     *
     * <p>TODO: Demonstrate {@code ChatMemory.set(...)} for memory compaction or state restoration.
     *
     * <p>Implementation outline: add several messages to a memory, replace them with a compact
     * summary message via {@code memory.set(List.of(summary))}, continue the conversation, and verify
     * the model can still use the summarized context.
     */
    @Test
    void replaceMemoryContentsWithSet() {
        // TODO: Create OpenAI chat model and MessageWindowChatMemory.

        // TODO: Add several user/AI messages to memory.

        // TODO: Replace the full history with a compact summary using memory.set(...).

        // TODO: Continue the conversation and verify the response reflects the summary.

        fail("TODO: Implement ChatMemory.set() compaction test");
    }
}
