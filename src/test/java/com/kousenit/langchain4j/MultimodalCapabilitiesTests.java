 ...
 *
 * <p>This lab demonstrates how to use LangChain4j with multimodal AI models for both image and
 * audio analysis. You'll learn how to: - Analyze local images using GPT-4 - Analyze remote images
 * from URLs - Process audio content with AudioContent - Extract structured data from multimodal
 * analysis results
 */
class MultimodalCapabilitiesTests {
   ...
   *
   * <p>Demonstrates how to analyze an image loaded from local resources using GPT-4 Vision.
   *
   * <p>TODO: Implement this test method: 1. Create a GPT-4 model using OpenAiChatModel.builder() 2.
   * Load the image from resources (bowl_of_fruit.jpg) with proper null checking 3. Convert the
   * image bytes to Base64 string 4. Create ImageContent and TextContent for the message 5. Send the
   * message to the model and get response 6. Add proper assertions to verify the response
   */
  @Test
   ...
   *
   * <p>Demonstrates how to analyze an image from a remote URL using GPT-4 Vision.
   *
   * <p>TODO: Implement this test method: 1. Create a GPT-4 model using OpenAiChatModel.builder() 2.
   * Use the provided image URL for a nature boardwalk 3. Create ImageContent from the URL and
   * TextContent for the prompt 4. Send the message to the model and get response 5. Add proper
   * assertions to verify the response contains landscape-related content
   */
  @Test
   ...
   *
   * <p>Demonstrates audio processing using AudioContent with Google's Gemini model.
   *
   * <p>TODO: Implement this test method: 1. Add @EnabledIfEnvironmentVariable annotation to check
   * for GOOGLEAI_API_KEY 2. Create a Google Gemini model using GoogleAiGeminiChatModel.builder() 3.
   * Use model name "gemini-2.5-flash-preview-05-20" which supports audio 4. Load audio data from
   * tftjs.mp3 file and Base64 encode it using readSimpleAudioData() 5. Create AudioContent with
   * "audio/mp3" MIME type and TextContent for the message 6. Send the message to the model with
   * proper error handling 7. Verify the audio transcription response
   */
  @Test
  ...
  void audioTranscriptionAnalysis() throws IOException {
    ...
    // TextContent textContent = TextContent.from("Please transcribe and analyze the content of this
    // audio file.");
   ...
   *
   * <p>TODO: This helper method is provided for the audio test. You can uncomment it when
   * implementing the audio test.
   */
   ...
   *
   * <p>TODO: Complete the interface method with proper annotation for comprehensive analysis
   */
   ...
   *
   * <p>This record is already complete - no TODO needed.
   */
   ...
   *
   * <p>Demonstrates extracting structured data from image analysis results.
   *
   * <p>TODO: Implement this test method: 1. Create GPT-4 model and DetailedAnalyst service 2. Load
   * image from resources with proper null checking 3. Get comprehensive structured analysis using
   * the service 4. Add assertions to verify all fields in the result record
   */
  @Test
