...
class AiServicesTests {
    ...
    void useFilmographyService() {
        ...
        FilmographyService service =
                AiServices.builder(FilmographyService.class).chatModel(model).build();
        ...
        System.out.printf(
                ...
                fullFilmography.actor(), fullFilmography.movies().size());

        // Verify results using JUnit assertAll for grouped assertions
        assertAll(
                "Filmography service results",
    ...
    void personalAssistantWithMemoryAndTools() {
        ...
        assertAll(
                ...
                () -> assertTrue(
                        response2.toLowerCase().contains("alice"),
    ...
    void advancedServiceConfiguration() {
        ...
        interface MovieAnalysisService {
            ...
            @UserMessage(
                    "Provide a brief analysis of {{movieTitle}} including rating (1-10), genres, and a short review")
        ...
        // Create AI service
        MovieAnalysisService service =
                AiServices.builder(MovieAnalysisService.class).chatModel(model).build();
        ...
        assertAll(
                "Individual service method results",
        ...
        assertThat(analysis).as("Complete movie analysis").satisfies(movieAnalysis -> {
