...
class McpIntegrationTests {
     ...
     *
     * <p>Steps to implement: 1. Create StdioMcpTransport with the npx stdio command for the
     * "everything" server 2. Create DefaultMcpClient with a unique key, the transport, and an
     * initialization timeout 3. Create McpToolProvider using the MCP client 4. Verify both client and
     * tool provider are created successfully 5. Close the MCP client when finished
     */
    @Test
